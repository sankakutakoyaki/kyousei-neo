...
public class RecycleMakerParameterBinder {
    public static void bindInsertRecycleMakerParameters(PreparedStatement pstmt, RecycleMakerEntity r) throws SQLException {
        int index = 1;
    ...
    public static void bindUpdateRecycleMakerParameters(PreparedStatement pstmt, RecycleMakerEntity r) throws SQLException {
        int index = 1;
        pstmt.setInt(index++, r.getCode());
        pstmt.setString(index++, r.getName());
        pstmt.setInt(index++, r.getVersion());
    ...
    public static void bindFindById(PreparedStatement ps, Integer recycleMakerId) throws SQLException {
        int index = 1;
