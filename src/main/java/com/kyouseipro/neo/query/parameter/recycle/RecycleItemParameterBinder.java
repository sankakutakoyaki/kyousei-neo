...
public class RecycleItemParameterBinder {
    public static void bindInsertRecycleItemParameters(PreparedStatement pstmt, RecycleItemEntity r) throws SQLException {
        int index = 1;
    ...
    public static void bindUpdateRecycleItemParameters(PreparedStatement pstmt, RecycleItemEntity r) throws SQLException {
        int index = 1;
        pstmt.setInt(index++, r.getCode());
        pstmt.setString(index++, r.getName());
        pstmt.setInt(index++, r.getVersion());
    ...
    public static void bindFindById(PreparedStatement ps, Integer recycleItemId) throws SQLException {
        int index = 1;
