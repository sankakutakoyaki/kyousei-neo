...
public class RecycleMakerLogSqlProvider implements LogSqlProvider {
    ...
    public String buildLogTable(String tableVar) {
        return "DECLARE " + tableVar + " TABLE (" + """
            recycle_maker_id INT, code INT, name NVARCHAR(255), kana NVARCHAR(255), abbr_name NVARCHAR(255), [group] INT,
    ...
    public String buildOutput() {
        return """
            OUTPUT INSERTED.recycle_maker_id, INSERTED.code, INSERTED.name, INSERTED.kana, INSERTED.abbr_name, INSERTED.[group],
    ...
    public String buildInsertLog(String tableVar, String action) {
        return """
            INSERT INTO recycle_makers_log (
              ...
              code, name, kana, abbr_name, [group], version, state
            )
