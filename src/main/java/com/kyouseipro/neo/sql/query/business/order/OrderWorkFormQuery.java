...
public class OrderWorkFormQuery {

    public static QueryDefinition orderWorkFormList() {
    ...
    public static QueryDefinition orderWorkFormDetail() {
        return QueryDefinition.select(
            """
            SELECT
                o.order_work_id,
    ...
    public static QueryDefinition orderWorkFormCsv() {
        String sql = """
            SELECT
                o.order_work_id,
                o.order_id,
