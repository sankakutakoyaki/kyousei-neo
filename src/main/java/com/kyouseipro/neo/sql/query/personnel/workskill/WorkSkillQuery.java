package com.kyouseipro.neo.sql.query.personnel.workskill;
...
public class WorkSkillQuery {

    public static QueryDefinition workSkillList() {
    ...
    public static QueryDefinition workSkillDetail() {
        return QueryDefinition.select(
            """
    ...
    public static QueryDefinition workSkillCsv() {
