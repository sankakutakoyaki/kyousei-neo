...
public class EmployeeEntity implements Entity {
    ...
    public String getInsertString() {
        ...
        // SimpleData
        sb.append(DatabaseService.getInsertLogTableString(this.getUser_name(), "employees", "作成"));
        return sb.toString();
    }
    ...
    public String getUpdateString() {
        ...
        sb.append("INSERT INTO employees_log SELECT * FROM @EmployeeTable;");
        // SimpleData
        sb.append(DatabaseService.getUpdateLogTableString(this.getUser_name(), "employees", "変更"));
        return sb.toString();
    }
    ...
    public static String getCsvString(List<Entity> items) {
        ...
        for (Entity item : items) {
            ...
            sb.append(Enums.gender.getDescriptionByNum(entity.getGender()) + ",");
            sb.append(Enums.bloodType.getDescriptionByNum(entity.getBlood_type()) + ",");
