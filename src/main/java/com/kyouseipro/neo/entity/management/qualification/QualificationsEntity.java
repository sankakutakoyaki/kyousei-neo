package com.kyouseipro.neo.entity.management.qualification;
...
public class QualificationsEntity implements CsvExportable {
    ...
    public String toCsvRow() {
        return Utilities.escapeCsv(String.valueOf(owner_id)) + "," +
               Utilities.escapeCsv(owner_name) + "," +
               Utilities.escapeCsv(qualification_name) + "," +
               Utilities.escapeCsv(number) + "," +
               Utilities.escapeCsv(String.valueOf(expiry_date));
    }
