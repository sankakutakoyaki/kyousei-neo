package com.kyouseipro.neo._backup.corporation.staff.controller;
...
import com.kyouseipro.neo._backup.corporation.staff.entity.StaffEntity;
import com.kyouseipro.neo._backup.corporation.staff.entity.StaffEntityRequest;
import com.kyouseipro.neo._backup.corporation.staff.service.StaffService;
import com.kyouseipro.neo._backup.dto.IdListRequest;
import com.kyouseipro.neo._backup.dto.IdRequest;
...
public class StaffApiController {
    ...
    public ResponseEntity<byte[]> downloadCsvByIds(@RequestBody IdListRequest ids, @AuthenticationPrincipal OidcUser principal) {
        String csv = staffService.downloadCsvByIds(ids, principal.getAttribute("preferred_username"));
