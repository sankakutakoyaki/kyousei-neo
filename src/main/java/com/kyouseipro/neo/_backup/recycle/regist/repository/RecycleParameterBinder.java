package com.kyouseipro.neo._backup.recycle.regist.repository;
...
import com.kyouseipro.neo._backup.recycle.regist.entity.RecycleDateEntity;
import com.kyouseipro.neo._backup.recycle.regist.entity.RecycleEntity;
import com.kyouseipro.neo._backup.recycle.regist.entity.RecycleEntityRequest;
...
public class RecycleParameterBinder {
    public static int bindInsert(PreparedStatement pstmt, RecycleEntity r, String editor, int index) throws SQLException {
        ...
        pstmt.setObject(index++, r.getUseDate());
        pstmt.setObject(index++, r.getDeliveryDate());
        pstmt.setObject(index++, r.getShippingDate());
        pstmt.setObject(index++, r.getLossDate());
