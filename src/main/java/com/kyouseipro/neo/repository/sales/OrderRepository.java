...
public class OrderRepository {
     ...
     * @return 成功件数を返す。
     */
    public Integer deleteOrderByIds(String sql, List<Integer> ids, String editor) {
        ...
        return sqlRepository.executeUpdate(
            sql,
            ps -> OrderParameterBinder.bindDeleteForIds(ps, ids, editor)
        );
     ...
     */
    public List<OrderEntity> downloadCsvOrderByIds(String sql, List<Integer> ids, String editor) {
        // List<Integer> orderIds = Utilities.createSequenceByIds(ids);
        // String sql = OrderSqlBuilder.buildDownloadCsvOrderForIdsSql(orderIds.size());

        return sqlRepository.findAll(
            sql,
            ps -> OrderParameterBinder.bindDownloadCsvForIds(ps, ids),
